...
public class KdlNodeSpaceImpl extends ASTWrapperPsiElement implements KdlNodeSpace {

  public KdlNodeSpaceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull KdlVisitor visitor) {
    visitor.visitNodeSpace(this);
  }
  ...
  @Override
  @Nullable
  public KdlEscline getEscline() {
    return findChildByClass(KdlEscline.class);
  }
